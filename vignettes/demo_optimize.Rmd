...
Different models can be specified using ddmodel option in `DAISIE_ML_CS`: 
...
with `idparsopt` and `idparsfix` within the DAISIE_ML_CS function. 
...
screen output of DAISIE_ML_CS. Once the optimization is completed, the program will output 
